    ...
    return (
      <View style={styles.container}>
        ...
        <SafeAreaView >
          ...
          <TouchableOpacity style={{width:200, backgroundColor:"blue", marginLeft:180, borderRadius:15, height:35, marginVertical:15 }} onPress={() => navigation.goBack()} >
            <Text style={{textAlign:"center", fontSize:20, color:"white", marginTop:2}}>Go Back</Text>
          </TouchableOpacity>
